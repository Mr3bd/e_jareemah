      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'نستخدم نظام التشفير باستخدام عدة خوارزميات مثل SHA256، كما نستخدم أسلوب تشفير End-to-end، ويضمن هذا الأسلوب حماية سرية وصحة البيانات وعدم التلاعب والاطّلاع عليها من قبل أشخاص غير مخولين لهم.',
