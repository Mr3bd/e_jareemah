            ...
            children: [
              ...
              TextFormField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: Obx(
                      () => controller.defendantController.value.text.isEmpty
                          ? const SizedBox()
                          : InkWell(
                              onTap: () {
                                controller.defendantController.update((val) {});

                                controller.defendantController.value.clear();
                              },
              ...
              TextFormField(
                  ...
                  onSaved: (newValue) {
                    newValue ??= '';
                    controller.descriptionController.value.text = newValue;
                  },
                  decoration: InputDecoration(
